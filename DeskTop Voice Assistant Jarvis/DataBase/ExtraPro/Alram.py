...
extracted_time = open('C:\\project\\complete jarvis series\\data.txt','rt')
time = extracted_time.read()
Time = str(time)

delete_time = open("C:\\project\\complete jarvis series\\data.txt",'r+')
...
def RingerNow(time):
   ...
   while True:
    ...
    if current_time == Alarm_Time:
       ...
       playsound("C:\\project\\complete jarvis series\\DataBase\\Sounds\\2.mp3")
